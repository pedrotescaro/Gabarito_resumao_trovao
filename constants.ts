...
const qui3EnthalpySvg = `<svg viewBox="0 0 350 200" xmlns="http://www.w3.org/2000/svg"><style>.txt { font-family: sans-serif; font-size: 12px; fill: hsl(var(--foreground)); }.axis { stroke: hsl(var(--muted-foreground)); stroke-width: 1; }.level { stroke: hsl(var(--border)); stroke-width: 1; stroke-dasharray: 3, 3; }.exo-color { stroke: #d03060; fill: #d03060; }.endo-color { stroke: #1589FF; fill: #1589FF; }.line { stroke-width: 2; fill: none; }</style><line x1="20" y1="180" x2="330" y2="180" class="axis" /><line x1="20" y1="180" x2="20" y2="20" class="axis" /><text x="250" y="195" class="txt">Caminho da Reação</text><text x="5" y="100" transform="rotate(-90 5 100)" text-anchor="middle" class="txt">Entalpia (H)</text><line x1="20" y1="80" x2="60" y2="80" class="level" /><text x="65" y="84" class="txt">Reagentes</text><path d="M 60 80 C 130 30, 200 140, 270 140" class="line exo-color" /><line x1="270" y1="140" x2="310" y2="140" class="level" /><text x="275" y="130" class="txt">Produtos</text><text x="140" y="110" class="txt exo-color" style="font-weight:bold;">Exotérmica (ΔH < 0)</text><path d="M 60 80 C 130 130, 200 40, 270 40" class="line endo-color" /><line x1="270" y1="40" x2="310" y2="40" class="level" /><text x="275" y="30" class="txt">Produtos</text><text x="140" y="60" class="txt endo-color" style="font-weight:bold;">Endotérmica (ΔH > 0)</text></svg>`;
